...
class ShortUrlsStorageGetTestCase(TestCase):
    SHORT_URLS_COUNT = 3
    ...
    def test_get_list(self) -> None:
        ...
        expected_slugs = {short_url.slug for short_url in self.short_urls}
        slugs = {short_url.slug for short_url in short_urls}
